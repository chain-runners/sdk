...
interface ChainRunnersOffChainRendererInterface extends ethers.utils.Interface {
  functions: {
...
export class ChainRunnersOffChainRenderer extends BaseContract {
  ...
  interface: ChainRunnersOffChainRendererInterface;
