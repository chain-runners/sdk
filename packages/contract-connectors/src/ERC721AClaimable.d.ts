...
interface ERC721AClaimableInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721AClaimable extends BaseContract {
  ...
  interface: ERC721AClaimableInterface;
